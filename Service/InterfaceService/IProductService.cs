...
namespace ShopPC.Service.InterfaceService
{
    ...
    {
        Task<ProductResponse> CreateProduct(string brandId,string categoryId,string? subCategoryId ,ProductRequest request, IFormFile file);
        Task<ProductResponse> UpdateProduct(string productId,string? brandId,string? categoryId,string? subCategoryId, ProductRequest request, IFormFile? file);
        ...
        Task<PaginatedResponse<ProductResponse>> GetProductByCategoryId(string categoryId, int pageNumber, int pageSize);
